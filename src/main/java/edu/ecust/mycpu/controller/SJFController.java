...
import edu.ecust.mycpu.service.SJFService;
...
public class SJFController {
    ...
    public Map<Integer, Map<String, List<PCB>>> sentFCFSData(@RequestBody String data){
        ...
        SJFService rs;
        if(currentTime==0){
            rs = new SJFService(blockupList,readyList,runList,finishList,jamList,modifiedallData,limitNum);
            blockupList.clear();
            readyList.clear();
            runList.clear();
            finishList.clear();
            ...
            rs = new SJFService(currentTime+1,blockupList,readyList,runList,finishList,jamList,modifiedallData);
