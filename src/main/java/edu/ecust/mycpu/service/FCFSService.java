...
public class FCFSService {
    ...
    public FCFSService(List<PCB> unreachedList, List<PCB> readyList, List<PCB> runList, List<PCB> finishList, List<PCB> jamList, Map<Integer,Map<String,List<PCB>>> allData, Integer processNum) {
        this.currentTime = 0;
    ...
    public FCFSService(Integer currentTime, List<PCB> unreachedList, List<PCB> readyList, List<PCB> runList, List<PCB> finishList, List<PCB> jamList, Map<Integer,Map<String,List<PCB>>> allData) {
    ...
    public void sortReadyList(){
        Collections.sort( readyList,new PCBComprator());
    }
